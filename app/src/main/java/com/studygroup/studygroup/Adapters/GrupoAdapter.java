 ...
 */
public class GrupoAdapter extends ArrayAdapter<GruposTemporales> {

    Context context;
    int resource, textViewResourceId;
    List<GruposTemporales> items, tempItems, suggestions;

    public GrupoAdapter(Context context, int resource, int textViewResourceId, List<GruposTemporales> items) {
        super(context, resource, textViewResourceId, items);
        this.context = context;
        this.resource = resource;
        this.textViewResourceId = textViewResourceId;
        this.items = items;
        tempItems = new ArrayList<GruposTemporales>(items);
        suggestions = new ArrayList<GruposTemporales>();
    }
